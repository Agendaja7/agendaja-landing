// Design: Clean white header with large, prominent AgendaJá  and text
// : Official AJ monogram + text "AgendaJá" - must be immediately legible
// Layout:  + text on left (large), nav items on right, CTAs on far right
